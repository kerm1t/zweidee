/* zweidee.h (c) 2017-2025
* holds 3 sections
* 
* (1) OpenGL
*     - Shader
*     - Render + attach to window-DC
*     - Framebuffer
* (2) Thread
* (3) windows (not needed for Linux/IOS!)
*     // most of this could be handled by SDL or GLFW, but at that time I didn't use either
*     // might be nice to check SDL3, as it can newer GPU-handler as Metal, Vulcan and DirectX
*     // https://wiki.libsdl.org/SDL3/CategoryGPU
*     // but anyway, I already have the metalified (IOS) zweidee https://github.com/kerm1t/zweidee_ios
* 
* 
* 2do:
* ----
* - move windows code out + compact, s. https://github.com/nclack/example-win32
* - attach to DC, for Linux? // move, too?
* - this will not run on Linux, as we don't have code to create a window anyway
    --> needed? or move to SDL
*/
...
namespace zweidee
{
  ...
  ////////////////////////////////
    ////
    ////    Shader code here, very simple atm
    ////
  ////////////////////////////////
...
*/      "void main()\n"
  ...
  ////////////////////////////////
    ////
    ////    OpenGL code + framebuf construction here
    ////
  ////////////////////////////////

  /* what happens here:
  *  - define VBO + VAO for OpenGL >= 3.x
  *    ... just explain the VBO / VAO concept quickly ...
  * 
  *  CRender class
  *    - Init()               init OpenGL
  *    - GL_attach_to_DC()    attach to device context, which is created in lower windows part
  *    - ReSizeGLScene()      react on changing window size
  *    - Setup_Geometry       create openGL geo *) for pasting the fbuf as texture
  *                                              2 triangles spanning the full screen / window
  *    - Bind_VBOs_to_VAOs()  still needed?
  *    - DrawVAOs_NEU()       now render!
  * 
  *  FrameBuf2D class
  *    - setpixel(uint8)      2do: this need to be more lean, move "data" to class
  *    - setpixel(float)
  *    - setpixel_glenz       consider current color of pixel when setting new
  *    - setpixel(int)
  *    - Init()               create the GL texture --> move to Render class ??
  */
...
////////////////////////////////
  ////
  ////    Windows / Autogenerated code here
  ////
////////////////////////////////

/* this is mostly autogenerated code from VStudio 201x
*  it can be reduced to less functions as in https://github.com/nclack/example-win32
* 
*/
